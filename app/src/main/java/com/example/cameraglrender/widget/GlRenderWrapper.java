...
public class GlRenderWrapper implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener, Camera2Helper.OnPreviewSizeListener, Camera2Helper.OnPreviewListener {
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        String faceCascadePath = new File(glRenderView.getContext().getFilesDir(), "lbpcascade_frontalface.xml").getAbsolutePath();
        String seetaModelPath = new File(glRenderView.getContext().getFilesDir(), "seeta_fa_v1.1.bin").getAbsolutePath();
        tracker = new FaceTracker(faceCascadePath, seetaModelPath, camera2Helper);
        tracker.startTrack();
