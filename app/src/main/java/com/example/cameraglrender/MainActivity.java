...
public class MainActivity extends AppCompatActivity implements OnRecordListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rxPermissions.request(Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.CAMERA).subscribe(granted -> {
